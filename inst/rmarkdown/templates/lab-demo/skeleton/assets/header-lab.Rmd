...
knitr::opts_chunk$set(dev="png",fig.retina=2,results="hold",fig.show="hold",fig.align="left",echo=TRUE,warning=FALSE,message=FALSE,accordion=NULL,block.title=NULL)
```
